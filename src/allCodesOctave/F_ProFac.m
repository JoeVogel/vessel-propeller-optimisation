function [ t,w,etaR ] = F_ProFac( L,B,C_B,C_P,C_M,T_F,T_A,LCB,S_APP,S,...
    apk1,apk2,C_F,C_A,Cstern,D,AEdAO,PdD,zP)
...
elseif zP == 2
    ...
    error('The number of propellers must be iqual to 1 or 2 only!');
end

% display(t); display(w); display(etaR);
